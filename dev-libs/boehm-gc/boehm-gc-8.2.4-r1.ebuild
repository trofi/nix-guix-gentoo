...
# ::nix-guix note: we apply a patch pending upstream inclusion.
# Otherwise `nix-2.20.1` fails to build:
#   https://bugs.gentoo.org/923624
...
PATCHES=(
	# Unreleased `boehm-gc` is a build prerequisite for `nix-2.20`:
	#   https://github.com/NixOS/nix/issues/9888
	"${FILESDIR}"/${P}-public-interfaces.patch
)
