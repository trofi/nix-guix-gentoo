...
# >=dev-libs/boehm-gc-8.2.4-r1: unreleased `boehm-gc` is a build
#   prerequisite for `nix-2.20`: https://github.com/NixOS/nix/issues/9888
RDEPEND="
	app-arch/brotli
	app-arch/bzip2
	app-arch/xz-utils
	...
	sys-libs/libseccomp
	sys-libs/zlib
	gc? ( >=dev-libs/boehm-gc-8.2.4-r1[cxx] )
